...
class OpLocation(models.Model):
    ...
    def getProvince(self):
        ...
        return OpLocation.objects.using('politici').provincia_from_location( self )
...
#        )
    ...
    def getRegion(self):
        ...
        return OpLocation.objects.using('politici').regione_from_location( self )
...
#        )
    ...
    def getConstituencies(self, election_type=None, prov_id=None):
        ...
        return OpConstituency.objects.db_manager('politici').filter(**kwargs)
